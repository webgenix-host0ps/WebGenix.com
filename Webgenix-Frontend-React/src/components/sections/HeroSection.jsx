 ...
 * 
 * Design decisions:
 * - Dark background for calm first impression
 * - Outcome-focused headline (not feature-focused)
 * - Single dominant CTA (reduces decision paralysis)
 * - No secondary CTA above the fold
 * - Generous vertical spacing for breathing room
 * 
 * Psychology: The hero must convey authority and clarity
 * in under 3 seconds. Every element competes for attention,
 * so we remove everything non-essential.
 */
