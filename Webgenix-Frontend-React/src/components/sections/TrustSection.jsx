 ...
 * 
 * Trust & Authority layer with reliability cues.
 * 
 * Design decisions:
 * - Clean grid of trust signals
 * - Icon + text pairs for quick scanning
 * - No exaggerated claims
 * - Calm confidence through understated design
 * 
 * Psychology: Trust is built through consistency and
 * competence signals. This section provides social proof
 * without manipulation or fake urgency.
 */
