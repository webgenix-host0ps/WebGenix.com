/**
 * Icon Component
 * Simple line-based icons using Lucide React style
 * Keeps the UI consistent and lightweight
 */

const iconPaths = {
    // Navigation & General
    'globe': <><circle cx="12" cy="12" r="10" /><path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z" /></>,
    'server': <><rect width="20" height="8" x="2" y="2" rx="2" ry="2" /><rect width="20" height="8" x="2" y="14" rx="2" ry="2" /><circle cx="6" cy="6" r="1" /><circle cx="6" cy="18" r="1" /></>,
    ...
    'hard-drive': <><line x1="22" x2="2" y1="12" y2="12" /><path d="M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z" /><circle cx="6" cy="16" r="1" /><circle cx="10" cy="16" r="1" /></>,
    ...
    // New icons for Static Hosting page
    'github': <><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.24c3.18-.35 6.5-1.5 6.5-7.16 0-1.49-.5-2.7-1.3-3.6.13-.32.55-1.7-.13-3.5 0 0-1.05-.34-3.5 1.3a12.2 12.2 0 0 0-6.3 0C5.55 1.25 4.5 1.5 4.5 1.5c-.68 1.8-.26 3.18-.13 3.5-.8.9-1.3 2.11-1.3 3.6 0 5.61 3.32 6.8 6.5 7.16A4.8 4.8 0 0 0 8 18v4" /><path d="M4 20c-1.5 0-2.5-1-4-1" /></>,
    ...
    // New icons for Dynamic Hosting page
    ...
    // New icons for Website Builder page
    ...
    // New icons for Ecommerce Builder page
    ...
    // New icons for Website Migration page
    ...
    // New icons for Domain Search page
    ...
    // New icons for Domain Transfer page
    ...
    // New icons for Business Email page
    'at-sign': <><circle cx="12" cy="12" r="4" /><path d="M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-4.5 8.4" /></>,
    'cloud': <><path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z" /></>,
    // New icons for Email Marketing
    'user-plus': <><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><line x1="19" x2="19" y1="8" y2="14" /><line x1="22" x2="16" y1="11" y2="11" /></>,
    // New icons for Google Workspace
    'mic-off': <><line x1="1" x2="23" y1="1" y2="23" /><path d="M9 9v3a3 3 0 0 0 5.12 2.12M15 9.34V4a3 3 0 0 0-5.94-.6" /><path d="M17 16.95A7 7 0 0 1 5 12v-2m14 0v2a7 7 0 0 1-.11 1.23" /><line x1="12" x2="12" y1="19" y2="23" /><line x1="8" x2="16" y1="23" y2="23" /></>,
    ...
    // New icons for SSL Certificate
    'arrow-left': <><path d="m12 19-7-7 7-7" /><path d="M19 12H5" /></>,
    // New icons for Backup Solutions
    'map': <><polygon points="3 6 9 3 15 6 21 3 21 18 15 21 9 18 3 21 3 6" /><line x1="9" y1="3" x2="9" y2="18" /><line x1="15" y1="6" x2="15" y2="21" /></>,
    'shield-off': <><path d="M19.69 14a6.9 6.9 0 0 0 .31-2V5l-8-3-3.16 1.18" /><path d="M4.73 4.73 4 5v7c0 6 8 10 8 10a20.29 20.29 0 0 0 5.62-4.38" /><line x1="1" x2="23" y1="1" y2="23" /></>,
