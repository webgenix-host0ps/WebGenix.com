 ...
 * 
 * 3-step visual flow explaining the onboarding process.
 * 
 * Design decisions:
 * - Visual > text (icons are prominent)
 * - Explains onboarding, not infrastructure complexity
 * - Simple numbered steps feel achievable
 * - Horizontal on desktop, vertical on mobile
 * 
 * Psychology: Breaking down the journey into 3 simple
 * steps makes getting started feel easy and achievable.
 * It reduces the "unknown" anxiety.
 */
